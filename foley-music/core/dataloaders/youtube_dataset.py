...
class YoutubeDataset(Dataset):
    ...
    def from_cfg(cls, cfg: ConfigTree, split='train'):
        return cls(
            ...
            duplication=cfg.dataset.duplication,
            fps=cfg.dataset.fps,
            events_per_sec=cfg.dataset.events_per_sec,
            random_shift_rate=cfg.dataset.random_shift_rate,
            pose_layout=cfg.dataset.pose_layout
        )
