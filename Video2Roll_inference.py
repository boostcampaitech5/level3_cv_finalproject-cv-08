...
def inference(net, data, est_roll_folder):
    ...
    for interval in range(50, len(data), 50):
        ...
        np.savez(
            f"{est_roll_folder}/" + str(start) + "-" + str(end) + ".npz",
            logit=save_est_logit,
            roll=save_est_roll,
        )
        i = i + 50
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--img_root",
        type=str,
        default="./data/ytdataset/images_nopad/testing",
        help="default: './data/ytdataset/images_nopad/testing'",
    )
    parser.add_argument(
        "--label_root",
        type=str,
        default="./data/ytdataset/labels_audeo/testing",
        help="default: './data/ytdataset/labels_audeo/testing'",
    )
    parser.add_argument(
        "--output_path",
        type=str,
        default="./outputs_test/v2r_output/",
        help="default: './outputs_test/v2r_output/'",
    )
